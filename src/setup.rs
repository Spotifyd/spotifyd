...
pub(crate) fn initial_state(
    ...
    main_loop::MainLoopState {
        ...
        spotifyd_state: main_loop::SpotifydState {
            ...
            player_event_track_change_program: config.on_track_change_hook,
            player_event_track_started_program: config.on_track_started_hook,
            player_event_track_stopped_program: config.on_track_stopped_hook,
            player_event_track_loading_program: config.on_track_loading_hook,
            player_event_track_playing_program: config.on_track_playing_hook,
            player_event_track_paused_program: config.on_track_paused_hook,
            player_event_track_preload_program: config.on_track_preload_hook,
            player_event_track_end_program: config.on_end_of_track_hook,
            player_event_volume_set_program: config.on_volume_set_hook,
            player_event_track_unavailable_program: config.on_track_unavailable,
